  ...
  return `
    <html>
      <body style="margin: 50px 50px;">
        ...
        <p>Thank you for signing up for being the Microblading Model at Outstanding Training Center!</p>
        <P>We will reach out to you once we have an opening for the ${ client.modelType } service you selected!</P>
        <p>
          <p>Thank you,</p>
